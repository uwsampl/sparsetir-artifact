...
def test_matmul(MODE,
    ...
    # print(a_tri)
    op = triton.ops.blocksparse.matmul(layout,
                                       BLOCK,
                                       MODE,
                                       trans_a=TRANS_A,
                                       trans_b=TRANS_B,
    ...
    print(
        "triton-block-sddmm\tM\t{}\tN\t{}\tK\t{}\tblock\t{}\tdtype\t{}\ttrans_A\t{}\ttrans_B\t{}"
        .format(M, N, K, BLOCK, DTYPE, TRANS_A, TRANS_B))
