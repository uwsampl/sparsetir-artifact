...
def test_matmul(MODE, TRANS_A, TRANS_B, BLOCK, DTYPE, Z=1, H=1, M=512, N=384, K=256):
    ...
    print("triton-block-spmm\tM\t{}\tN\t{}\tK\t{}\tblock\t{}\tdtype\t{}\ttrans_A\t{}\ttrans_B\t{}\ttime(ms)\t{}".format(M, N, K, BLOCK, DTYPE, TRANS_A, TRANS_B, accum / total))
        ...
        for dtype in [torch.float32, torch.float16]:
            for trans_A in [False, True]:
                for trans_B in [False, True]:
                    test_matmul("dsd", trans_A, trans_B, block, dtype, Z=1, H=1, M=512, N=384, K=256)
